...
@section('content')
	...
	<p>Your registration for the CIArb International Conference 2018 has been received. Below are the details.</p>
	...
	<div class="row">
		<div class="col-sm-12">
			<p>
				If you have not paid and would like to pay, you can make your payment of <strong>{{ env('CURRENCY') }} {{ $user->price }}</strong> through the following methods.
			</p> <br>
		</div>
